...
def get_podman_version() -> version.Version:
    ...
    if _podman_version is None:
        ...
        except Exception as exc:  # noqa: BLE001 – anything can happen here
...
def should_skip_podman_version(podman_version: str) -> bool:
    if get_podman_version() == version.parse(podman_version):
        return True
    return False
